    ...
    var Node = function(obj) {
      ...
      this.render = function(rootAttr, carouselAttr) {
        ...
        if (attributes.tags == "attachment") {
          this.$el = $('<node><div class="view"><div class="exp">...</div><div class="tags"></div><div class="file"><a href="' + attributes.img + '" target="_blank"></a></div><div class="info"><div class="title-box"></div></div></node>');
                  ...
                  success : function(data) {
                    if (isValid(data)) {
                      for (var i = 0; i < data.nodes.length; i++) {
                        ...
                        if (data.nodes[i].img != "") {
                          tmpl += '<div class="img"><img class="query" src="' + data.nodes[i].img + '"/></div><div class="info">';
                        } else {
      ...
      this.redrawLinks = function(nID) {
        for (var i in links) {
          if (links[i].isRelated(nID) && 
            ...
            nodeByID(links[i].nodeID()).$el[0].parentNode.id !== "carousel-items" && 
            nodeByID(links[i].linkedNodeID()) && 
            nodeByID(links[i].linkedNodeID()).$el[0].parentNode.id !== "carousel-items") {
